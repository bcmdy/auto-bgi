...
1、背包统计优化，相同日期取最新一条，数量没有变化，取最新的日期

2、新增实时屏幕（会增加功耗）

3、联机狗粮和批发收益计算合并

4、obs自动录屏功能，关键词触发回放缓存（具体看教程）

https://gitee.com/wangjian0327/auto-bgi/blob/ginVue/READMEOBS&&ABGI.md
...
8、收获前10改成收获数量超过10，有相似度计算，只要不是ocr太离谱，程序基本上都可以判断出材料真实名字是什么，做数量合并
