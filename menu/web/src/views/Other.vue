                            ...
                            <div class="group-title" @click="toggleGroupDetails(group.GroupName)">
                                ...
                                <div v-for="(seg,index) in group.Segments" :key="index">
                                    ...
                                    <div class="group-time-info">
                                        ...
                                        <span class="duration-badge" style="background-color: #FCF791;display: inline-flex;align-items: center">
                                            <svg t="1769046672535" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1697" width="18" height="18">
